...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> NUNC_ANULUS_TAB = CREATIVE_MODE_TAB.register("nunc_anulus_tab",
            () -> CreativeModeTab.builder()
                    .icon(() -> new ItemStack(ModItems.ANULITE.get()))
                    .title(Component.translatable("creativetab.nuncanulus.nunc_anulus"))

package net.generic_user94.nuncanulus.block.Pedestal;
...
public class PedestalBlock extends BaseEntityBlock {
    ...
    //Shape
    public static final VoxelShape SHAPE = PedestalBlock.box(2, 0, 2, 14, 13, 14);
    // codec (?)
    ...
    protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
            if(level.getBlockEntity(pos) instanceof PedestalBlockEntity pedestalBlockEntity) {
                ...
                if(pedestalBlockEntity.inventory.getStackInSlot(0).isEmpty() && !stack.isEmpty()){
                    ...
                    stack.shrink(1);
                    level.playSound(player, pos, SoundEvents.PANDA_SNEEZE, SoundSource.BLOCKS, 1f, 8f);
                    ...
                    player.setItemInHand(InteractionHand.MAIN_HAND, stackOnPedestal);
                    pedestalBlockEntity.inventory.setStackInSlot(0, stackInHand);
                    level.playSound(player, pos, SoundEvents.PANDA_SNEEZE, SoundSource.BLOCKS, 1f, 8f);
